...
//
const BotName = 'T3GZBOT'; // Nama Bot Whatsapp
const instagramlu = 'https://www.instagram.com/tegarxzy/'; // Nama Instagramlu cok
const whatsapplu = '0895-0329-4960'; // Nomor whatsapplu cok
const kapanbotaktif = '24 Jam'; // Kapan bot lu aktif
const grupch1 = '𝐒𝐲𝐧𝐜𝐗𝐭𝐞𝐭𝐡𝐢𝐜'; // OFFICIAL GRUP LU 1
const grupch2 = '𝐒𝐲𝐧𝐜𝐗𝐭𝐞𝐭𝐡𝐢𝐜'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] Tegarxzy Ready scan now!`);
});
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @tegarxzy`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @tegarxzy`)
})
...
conn.sendMessage(id, 'Owner tegar wa.me/628903294960' ,MessageType.text);
}
else if (text == 'Ngentod'){
conn.sendMessage(id, 'Pengin ngentot?' ,MessageType.text);
}
else if (text == 'Anjing'){
